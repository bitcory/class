...
export const week1: Week = {
  ...
  slides: [
    ...
    },
    {
      ...
      tone: "concept",
      type: "gallery",
      title: "이미 수백명이 저에게 AI를 배우시고 있습니다.",
      lead:
        "저는 'AICREW' 아카데미를 운영하며, 4명의 보조강사와 340명의 수강생을 가르치고 있습니다. EBS에서 경기영상고 학생들도 가르쳤습니다.",
      stats: [
        { value: "340명", label: "직접 가르치고 있는 수강생" },
