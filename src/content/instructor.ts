...
export const instructor = {
  ...
  intro: [
    "AI 교육 브랜드 '아이크루(AICREW)'를 운영합니다. 보조강사 4명과 함께 342명을 가르치고 있고,\nEBS 특강에서는 경기영상고 학생들을 만났습니다.",
    "5년째 AI에게 말을 걸어서 프로그램을 만듭니다. 지금 보고 계신 이 사이트도 그렇게 만들었습니다.",
  ...
  career: [
    ...
    {
      year: "5년째",
      text: "AI 개발자 — 챗지피티가 나올 때부터 바이브코딩으로 웹서비스·업무 도구를 직접 제작",
    },
    {
      year: "이전",
  ...
  lectures: [
    ...
    "오프라인 기반 AI 강의 (누적 340명)",
    "오픈채팅방 기반 온라인 AI 강의 (누적 113명)",
    "아이크루 아카데미 운영 — 제로 · 업 · 프로 · 마스터 4단계 과정",
    "대학원 생성형 AI 활용 실무 4주 과정(수행중)",
    "AIDCA(AI드라마크리에이터협회) 소속",
  ],
  /** 수업에서 실제로 다루는 도구들 */
  tools: [
    "챗지피티",
