...
export const instructor = {
  ...
  intro: [
    "AI 교육 브랜드 '아이크루(AICREW)'를 운영하고 있습니다. 보조강사 4명과 함께 330명의 수강생을 직접 가르치고 있고, EBS 특강에서는 경기영상고 3학년 학생들에게 영상 제작을 강의했습니다.",
    "5년째 AI로 직접 프로그램을 만들고 있습니다. 컴퓨터공학을 전공한 게 아니라, AI에게 말을 걸어서 만드는 '바이브코딩' 방식입니다. 지금 보고 계신 이 강의 사이트도 그렇게 만들었습니다.",
    "그전에는 렌탈 유통 회사를 경영하고, 소프트웨어 영업을 하고, 카카오 계열사 임원으로도 일했습니다. 현장에서 오래 일해 본 사람이라, 이론보다 \"오늘 끝나면 손에 결과물이 남는\" 수업을 지향합니다.",
